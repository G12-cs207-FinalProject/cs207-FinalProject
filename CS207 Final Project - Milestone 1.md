...
The following module allows users  to input an XML file with elementary reaction data and outputs reaction kinetics for each species and for every reaction provided by the user.

The final result is that for a system consisting of $$N$$ species undergoing $$M$$ **irreversible**, **elementary** reactions of the form 
